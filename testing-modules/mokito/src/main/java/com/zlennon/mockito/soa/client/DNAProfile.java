...
public class DNAProfile  implements java.io.Serializable {
    private com.zlennon.mockito.soa.client.ProfileElement[] dnaElements;

    public DNAProfile() {
    }

    public DNAProfile(
           com.zlennon.mockito.soa.client.ProfileElement[] dnaElements) {
     ...
     * @return dnaElements
     */
    public com.zlennon.mockito.soa.client.ProfileElement[] getDnaElements() {
        return dnaElements;
    }
     ...
     * @param dnaElements
     */
    public void setDnaElements(com.zlennon.mockito.soa.client.ProfileElement[] dnaElements) {
        this.dnaElements = dnaElements;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dto.soa.mockito.zlennon.com", "DNAProfile"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dnaElements");
        elemField.setXmlName(new javax.xml.namespace.QName("http://dto.soa.mockito.zlennon.com", "dnaElements"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://dto.soa.mockito.zlennon.com", "ProfileElement"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://zlennon.webservice.com", "item"));
