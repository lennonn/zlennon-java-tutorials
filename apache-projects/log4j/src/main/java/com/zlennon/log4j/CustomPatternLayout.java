...
/**
    ...
    public String hideMarkLog(String logStr) {
        try {
            ...
            //通用型
 */
/*           String otherReg = KEY_REG_MAP.get("other");
            logStr = matchingAndEncrypt(logStr, otherReg, "other");
            //String pwdReg = KEY_REG_MAP.get("other");

            if(logStr.contains("pwd")){
...
/**
    ...
    private static String matchingAndEncrypt(String msg, String regExp, String key) {
        ...
        //boolean contains = Log4j2Rule.OTHER.contains(key);
        String hiddenStr = "";
        while (matcher.find()) {
