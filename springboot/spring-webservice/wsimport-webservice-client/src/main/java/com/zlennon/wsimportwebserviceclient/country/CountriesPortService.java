 ...
 * 
 */
@WebServiceClient(name = "CountriesPortService", targetNamespace = "http://zlennon.com/webservices/country", wsdlLocation = "http://localhost:5003/ws/countries.wsdl")
    ...
    extends Service
{
    ...
    private final static QName COUNTRIESPORTSERVICE_QNAME = new QName("http://zlennon.com/webservices/country", "CountriesPortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:5003/ws/countries.wsdl");
    ...
    public CountriesPort getCountriesPortSoap11() {
        return super.getPort(new QName("http://zlennon.com/webservices/country", "CountriesPortSoap11"), CountriesPort.class);
    }
    ...
    public CountriesPort getCountriesPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://zlennon.com/webservices/country", "CountriesPortSoap11"), CountriesPort.class, features);
    }
