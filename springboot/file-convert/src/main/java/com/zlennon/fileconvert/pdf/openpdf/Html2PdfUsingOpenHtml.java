package com.zlennon.fileconvert.pdf.openpdf;
...
public class Html2PdfUsingOpenHtml {
    ...
    private static final String HTML_INPUT = "src/main/resources/ReactorGuide.html";
    private static final String PDF_OUTPUT = "D:/ReactorGuide.pdf";
    ...
    private void generateHtmlToPdf() throws IOException {
        //File inputHTML = new File(HTML_INPUT);
         ClassPathResource classPathResource = new ClassPathResource("ReactorGuide.html");
         File inputHTML = classPathResource.getFile();
