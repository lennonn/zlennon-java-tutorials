 ...
 */
package com.zlennon.oauth2webclient.controller.web;
...
public class DeviceController {
	...
	public String authorize(Model model) {
		...
		model.addAttribute("deviceCode", responseParameters.get(OAuth2ParameterNames.CODE));
		model.addAttribute("expiresAt", expiresAt);
		model.addAttribute("userCode", responseParameters.get(OAuth2ParameterNames.CODE));
	...
	public ResponseEntity<Void> poll(@RequestParam(OAuth2ParameterNames.CODE) String deviceCode,
