package com.zlennon.springintegration.intermediate.advice;
...
public class TransactionConfig {
    ...
    public final String INPUT_DIR = "G:/zlennon/spring/tx/";
    public final String FILE_PATTERN = "*.txt";



    @Bean
    public MessageChannel txInputChannel() {
        return new DirectChannel();
    }

    @Bean
    @InboundChannelAdapter(value = "txInputChannel", poller = @Poller(value = "pollerMetadata"))
    public MessageSource<File> txFileReadingMessageSource() {
    ...
    @Bean
    @Transformer(inputChannel = "txInputChannel", outputChannel = "toServiceChannel")
    ...
    public void serviceActivator(String payload) {
        ...
        jdbcTemplate(dataSource()).update("insert into STUDENT values(?)", payload);
    ...
    public static void main(final String... args) {
        final AbstractApplicationContext context = new AnnotationConfigApplicationContext(TransactionConfig.class);
