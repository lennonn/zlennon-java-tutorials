...
import com.zlennon.domain.DistributedTransactionParticipant;
import com.zlennon.domain.DistributedTransactionStatus;
import com.zlennon.repo.DistributedTransactionRepo;
...
public class TransactionServerController {
    ...
    protected void publishEvent(DistributedTransaction transaction) {
        rabbitTemplate.convertAndSend("txn-events", "txn-events",  JSONObject.toJSONString(transaction));
    }
