package com.zlennon.apachekafka.streams;

import com.zlennon.apachekafka.ApacheKafkaApplication;
...
@Slf4j
@Testcontainers
@SpringBootTest(classes = ApacheKafkaApplication.class, webEnvironment = WebEnvironment.RANDOM_PORT)
