...
public class R<T> implements Serializable {
    ...
    public R(int code, T data, String... args) {
        this.code = code;
        this.data = data;
        this.multiArg = args;
        this.success = ResultCode.SUCCESS.code == code;
    ...
    public static <T> R<T> data(T data) {
        return new R(ResultCode.SUCCESS.code, data);
    }
    ...
    public static <T> R<T> fail(int code, String msg) {
        return new R(code, (Object)null, new String[]{msg});
    }
    ...
    public void setMultiArg(String[] multiArg) {
        this.multiArg = multiArg;
    }
