...
public class Main02 {
    ...
    public static void main(String[] args) {
        ...
        Path target1 = FileSystems.getDefault().getPath("D:/IdeaProject/zlennon-java-tutorials/java-modules/java-core/src/main/resources/rafaelnadal/photos", "rafa_winner.jpg");
        try {
        ...
        Path target2 = FileSystems.getDefault().getPath("D:/IdeaProject/zlennon-java-tutorials/java-modules/java-core/src/main/resources/rafaelnadal/photos", "rafa_winner.jpg");
        try {
        ...
        Path target3 = FileSystems.getDefault().getPath("D:/IdeaProject/zlennon-java-tutorials/java-modules/java-core/src/main/resources/rafaelnadal/photos", "rafa_winner.jpg");
        try {
