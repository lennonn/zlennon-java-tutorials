 ...
 * @author Apress
 */
class MoveTree07 implements FileVisitor {

    private final Path moveFrom;
    private final Path moveTo;
    static FileTime time = null;

    public MoveTree07(Path moveFrom, Path moveTo) {
...
class Main07 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path moveFrom = Paths.get("D:/IdeaProject/zlennon-java-tutorials/java-modules/java-core/src/main/resources/rafaelnadal");
        Path moveTo = Paths.get("C:/ATP/players/rafaelnadal");

        MoveTree07 walk = new MoveTree07(moveFrom, moveTo);
