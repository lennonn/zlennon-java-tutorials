...
public class Main19 {
    ...
    public static void main(String[] args) {
        ...
        Path newfile_1 = FileSystems.getDefault().getPath("D:/IdeaProject/zlennon-java-tutorials/java-modules/java-core/src/main/resources/rafaelnadal/tournaments/2010/SonyEricssonOpen.txt");
