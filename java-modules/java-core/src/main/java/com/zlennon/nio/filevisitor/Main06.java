...
class Main06 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path copyFrom = Paths.get("D:/IdeaProject/zlennon-java-tutorials/java-modules/java-core/src/main/resources/rafaelnadal");
        Path copyTo = Paths.get("D:/IdeaProject/zlennon-java-tutorials/java-modules/java-core/src/main/resources/rafaelnadal_copy");
